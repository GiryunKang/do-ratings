  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="text-sm text-muted-foreground space-y-4 leading-relaxed">
        ...
        <h2 className="text-base font-semibold text-foreground pt-2">{ko ? '5. 계정 관리' : '5. Account Management'}</h2>
        ...
        <h2 className="text-base font-semibold text-foreground pt-2">{ko ? '6. 서비스 중단 및 변경' : '6. Service Modification'}</h2>
        ...
        <h2 className="text-base font-semibold text-foreground pt-2">{ko ? '7. 면책 조항' : '7. Disclaimer'}</h2>
        ...
        <h2 className="text-base font-semibold text-foreground pt-2">{ko ? '8. 지적 재산권' : '8. Intellectual Property'}</h2>
        ...
        <h2 className="text-base font-semibold text-foreground pt-2">{ko ? '9. 준거법' : '9. Governing Law'}</h2>
        ...
        <h2 className="text-base font-semibold text-foreground pt-2">{ko ? '10. 문의' : '10. Contact'}</h2>

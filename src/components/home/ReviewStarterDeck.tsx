    ...
    <section>
      ...
      <div className={`${card.bgColor} rounded-xl p-5 sm:p-8 text-center transition-colors duration-300`}>
        ...
        <div className="flex items-center justify-center gap-4 mt-5">
          <button type="button" onClick={prev} className="p-2 rounded-full border border-border/50 text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors bg-white/60 dark:bg-white/10">
          ...
          <button type="button" onClick={next} className="p-2 rounded-full border border-border/50 text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors bg-white/60 dark:bg-white/10">

              ...
              <Link key={item.id} href={`/${locale}/subject/${item.id}`}
                ...
                {item.image_url ? (
                  <div className="h-24 relative overflow-hidden">
                    ...
                    <img src={proxyImageUrl(item.image_url) ?? ''} alt={name} className="w-full h-full object-cover group-hover:scale-105 transition-transform" onError={(e) => { e.currentTarget.style.display = 'none'; }} />

...
export default function ReviewForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-card rounded-xl border border-border p-5">
        ...
        <div className="flex items-center gap-3 justify-center">
          {[1, 2, 3, 4, 5].map(star => (
            ...
            >
              <svg className={`w-10 h-10 ${star <= directRating ? 'text-yellow-400' : 'text-gray-200'}`} fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 relative z-0">
